...
contract CommunityToken is ERC721, ERC721URIStorage, ERC721Burnable, Ownable, TokenTransferRequest {
    ...
    /////////////////////////////////////////////////
    // Overrides required for approval mechanism   //
    /////////////////////////////////////////////////
    ...
    function initiateTransferRequest(address to, uint256 tokenId) external {
    ...
    function approveTransferRequest(uint256 tokenId) external {
    ...
    function completeTransferRequest(uint256 tokenId) external {
